...
<div class="row">
  ...
  <div class="d-flex justify-content-center col-md">
    <div class="bg-image hover-overlay ripple m-3  rounded" data-mdb-ripple-color="light"
      ...
      <img src="img/buku/list/smp.png" class="w-100" alt="Louvre" />
  ...
  <div class="col">
    ...
    <p class="fs-3 fw-lighter m-0">untuk SMP/MTS</p>
    ...
    <p class="fw-bold fs-5">64 Halaman</p>
    <p class="m-0">Berat</p>
    <p class="fw-bold fs-5">100 gr</p>
    ...
    <div class="row">
      ...
      <div class="container" style="text-align: justify;">
        Buku Pesantren Ramadhan hadir sebagai buku yang berisi penjelasan mengenai thaharah (bersuci), pengertian dan dasar hukum puasa ramadhan, syarat sah, syarat wajib & rukun dalam menjalankan ibadah puasa, hal-hal yang dapat membatalkan puasa, panduan amalan dan ibadah wajib dan sunah di bulan Ramadhan, beserta lembar kegiatan harian di bulan ramadhan untuk pelajar jenjang SMP/MTs/sederajat.
