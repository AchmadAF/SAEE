...
<div class="row">
  ...
  <div class="d-flex justify-content-center col-md">
    <div class="bg-image hover-overlay ripple m-3  rounded" data-mdb-ripple-color="light"
      ...
      <img src="img/buku/list/sma.png" class="w-100" alt="Louvre" />
  ...
  <div class="col">
    ...
    <p class="fs-3 fw-lighter m-0">untuk SMA/SMK/MA/MAK</p>
    ...
    <p class="fw-bold fs-5">80 Halaman</p>
    <p class="m-0">Berat</p>
    ...
    <div class="row">
      ...
      <div class="container" style="text-align: justify;">
        Buku Pesantren Ramadhan hadir sebagai buku yang berisi penjelasan mengenai thaharah (bersuci), puasa ramadhan, zakat, etika dalam bergaul (akhlak), kajian fikih kontemporer, dan moderasi beragama dalam kehidupan sehari-hari, beserta lembar kegiatan harian di bulan ramadhan untuk pelajar jenjang SMA/SMK/MA/MAK.
      </div>
